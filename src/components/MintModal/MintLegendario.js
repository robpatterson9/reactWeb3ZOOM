            ...
            <Grid container spacing={2} className={classes.container} justify="space-between">
              <Grid
                ...
                <div className={classes.imagePad}>
                  ...
                  <Image
                      src="assets/images/Capsulas/AMARILLO-1.png"
                 ...
                 <div className={classes.imagePad}>
                   <Image
                      src="assets/images/Capsulas/AMARILLO-2.png"
                      className={classes.image}
                      alt="ROJO-2"
                   />
                  </div>
                <div className={classes.imagePad}> 
                 <Image
                      src="assets/images/Capsulas/AMARILLO-3.png"
                      className={classes.image}
                      alt="ROJO-3"
                  />
                </div>
