  ...
  const mint = async () => {
    ...
    try{
      ...
      if (tx.status === 1) {
        ...
        setLoadingStatus(false)
        enqueueSnackbar(`No Available.`, { variant: 'error' });
        return;
      }
    }
    catch {
            ...
            <Grid container spacing={2} className={classes.container} justify="space-between">
              <Grid
                ...
                <div className={classes.imagePad}>
                  ...
                  <Image
                      src="assets/images/Capsulas/AZUL-1.png"
                 ...
                 <div className={classes.imagePad}>
                   <Image
                      src="assets/images/Capsulas/AZUL-2.png"
                      className={classes.image}
                      alt="AZUL-2"
                   />
                  </div>
                <div className={classes.imagePad}> 
                 <Image
                      src="assets/images/Capsulas/AZUL-3.png"
                      className={classes.image}
                      alt="AZUL-3"
                  />
                </div>
